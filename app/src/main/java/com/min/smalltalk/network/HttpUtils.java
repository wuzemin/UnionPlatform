...
public class HttpUtils {
    private static final String BASE_RUL = "http://192.168.0.209/APP2/appapi/app";
    public static final String IMAGE_RUL = "http://192.168.0.209/APP2";
...
//                .addParams("list",list)
    ...
    public static void postRegisterRequest(String url, String nickname, String phone, String password,
                                           String userid, StringCallback callback) {
        OkHttpUtils.post().url(BASE_RUL + url)
                .addHeader("Connection", "close")
                .addParams("nickname", nickname)
                .addParams("phone", phone)
    ...
    //好友认领列表---已推荐好友
    public static void postRecommendFriendsList(String url, String userId, StringCallback callback) {
        OkHttpUtils.post().url(BASE_RUL + url)
                .addHeader("Connection", "close").addParams("userId", userId).build().execute(callback);
    }
    ...
    //认领好友
    public static void postClaimUser(String url, String userId, String friends_userId, String full_name,
                                     String mobile, StringCallback callback) {
        OkHttpUtils.post().url(BASE_RUL + url)
                .addHeader("Connection", "close")
                .addParams("userId", userId)
                .addParams("friends_userId", friends_userId)
