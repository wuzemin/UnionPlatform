...
import com.min.smalltalk.adapter.MinutesAdapter;
import com.min.smalltalk.adapter.NumericWheelAdapter;
import com.min.smalltalk.listener.OnWheelChangedListener;

import java.util.Arrays;
import java.util.List;

import static com.min.smalltalk.R.id.hour;
...
public class WheelMain {
    ...
    public void initDateTimePicker(int year, int month, int day, int h, int m) {
        ...
        wv_hours = (WheelView) view.findViewById(hour);
...
//		}
    ...
    /**
     * @Description: TODO 弹出日期时间选择器----年-月--日
     */
    public void DateTimePicker(int year, int month, int day) {
        // int year = calendar.get(Calendar.YEAR);
        // int month = calendar.get(Calendar.MONTH);
        // int day = calendar.get(Calendar.DATE);
        // 添加大小月月份并将其转换为list,方便之后的判断
