...
public class MyStartRecognizePlugin implements IPluginModule {
    ...
    public Drawable obtainDrawable(Context context) {
        L.e("------------","obtainDrawable");
        return ContextCompat.getDrawable(context, R.mipmap. rc_ic_phone_normal);
    }

    @Override
    public String obtainTitle(Context context) {
        L.e("------------","obtainTitle");
        return context.getString(R.string.speech_recognition);
    }
    ...
    public void onClick(Fragment fragment, RongExtension rongExtension) {
        L.e("----------","onclick"+flag);
        if(flag) {
            T.showShort(context, "开始说话，再点一下结束");
